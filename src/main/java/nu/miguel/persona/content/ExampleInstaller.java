...
public final class ExampleInstaller {
    public static final List<String> AVAILABLE=List.of("behaviors/builder-routine.yml","behaviors/keeper-festival.yml","behaviors/keeper-player.yml","behaviors/keeper-shared.yml","behaviors/private-walker.yml","dialogues/builder.yml","dialogues/builder_delivery.yml","dialogues/builder_thanks.yml","dialogues/trial_active.yml","dialogues/trial_complete.yml","dialogues/trial_intro.yml","npcs/builder.yml","npcs/harbor_keeper.yml","npcs/private-walker.yml","npcs/trial_master.yml","quests/adventurers_trial.yml","quests/supplies.yml","scripts.yml");
